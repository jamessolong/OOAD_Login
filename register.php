...
<div class="container ">
        <div class="notification">
                        ...
                        <div class="field">
                                <div class="control">
                                        <input class="input is-info is-medium" type="password" placeholder="Password" id="password">
                                </div>
                              </div>    

        <div class="field">
                                    <div class="control">
                                            <input class="input is-info is-medium" type="password" placeholder="Repeat-Password" id="repassword">
                                    </div>
                                  </div> 
                                                </fieldset>
                                            </form>
